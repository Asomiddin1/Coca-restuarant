            ...
            <div className='pt-[5%] flex flex-col items-center'>
                ...
                <div className='w-[320px]'>
                    <div className='pt-6 flex gap-4'>
                        <button className='px-[37px] py-2 text-[18px] text-white rounded-[25px] bg-[#FF5C00]'>Clock in</button>
                        <button className='px-[37px] py-2 text-[18px] rounded-[25px]  bg-white text-[#FF5C00]'>Clock out</button>
                    </div>
